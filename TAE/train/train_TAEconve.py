...
if args.pred == 'sub':
    mkdirs('./results/sub/{}'.format(args.dataset))
    model_state_file = "./results/sub/{}/model_state.pth".format(args.dataset)
elif args.pred == 'obj':
    mkdirs('./results/obj/{}'.format(args.dataset))
    model_state_file = "./results/obj/{}/model_state.pth".format(args.dataset)
else:
    mkdirs('./results/rel/{}'.format(args.dataset))
    model_state_file = "./results/rel/{}/model_state.pth".format(args.dataset)
